...
> 🚧 **Early access · under active development** — v0.7.10 is sim-first; drive the twin in your browser now, real-Skate support lands with the hardware.
...
| Work-camera point cloud | A **PCL** toggle back-projects the work camera's depth into the twin — a coloured 3D point cloud of what it sees (table, target), the input a point-cloud grasp planner would use |
